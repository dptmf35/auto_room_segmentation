...
def main():
    ...
    parser.add_argument("--output", type=str, default="output_map.png", help="출력 이미지 파일명")
    parser.add_argument("--json_output", type=str, default="centroids.json", help="센트로이드 JSON 출력 파일명")
